...
class PDFOutput(object):
    ...
    def __init__(self, errorsFile=ERROR_FILE, avoidColors=False):
        """
            @errorsFile: path to the log error file
            @avoidColors: Bool to prevent color on output
        """
        ...
        self.staticColor = ''
        self.resetColor = ''
        if avoidColors or not COLORIZED_OUTPUT:
